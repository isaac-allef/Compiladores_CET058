...
static const char *const yytname[] =
{
  ...
  "VERDADEIRO", "FALSO", "MAIOR", "MAIOR_IGUAL", "MENOR", "MENOR_IGUAL",
  "SE", "ABRE_CHAVE", "FECHA_CHAVE", "RECEBE", "IDENTIFICADOR", "INTEIRO",
  "EOL", "$accept", "calc", "statement", "tipo_variavel", "atribuicao",
  "corpo", "exp_bool", "exp", "fator", "termo", YY_NULLPTR
};
#endif
...
{
     -10,     1,   -10,   -10,     2,    -3,   -10,    12,     3,   -10,
      -2,     0,   -10,   -10,   -10,    21,    18,    16,   -10,    -3,
     -10,    36,    36,   -10,    36,    36,    19,   -10,    36,    36,
      36,    36,   -10,     0,     0,   -10,   -10,   -10,    24,     4,
       4,     4,     4,   -10
};
...
{
       2,     0,     1,    25,     0,     0,     9,     0,     0,     6,
       0,    19,    22,    13,    14,     0,     0,     0,     4,     7,
       8,     0,     0,     3,     0,     0,     0,     5,     0,     0,
       0,     0,    10,    20,    21,    23,    24,    11,     0,    15,
      17,    16,    18,    12
};
...
{
     -10,   -10,    15,   -10,    34,   -10,   -10,    -4,    -9,    -8
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     7,     8,     9,    27,    15,    10,    11,    12
};
...
{
      16,     2,    21,    22,     3,     3,    24,    25,    21,    22,
      13,    14,    33,    34,    17,     4,    35,    36,    23,     5,
       6,    19,    21,    22,    39,    40,    41,    42,    28,    29,
      30,    31,    18,     4,    32,    37,    26,     5,     6,     3,
      43,    38,    20
};
...
{
       4,     0,     4,     5,     3,     3,     6,     7,     4,     5,
       8,     9,    21,    22,    17,    14,    24,    25,    20,    18,
      19,    18,     4,     5,    28,    29,    30,    31,    10,    11,
      12,    13,    20,    14,    18,    16,    15,    18,    19,     3,
      16,    26,     8
};
...
{
       0,    22,     0,     3,    14,    18,    19,    23,    24,    25,
      28,    29,    30,     8,     9,    27,    28,    17,    20,    18,
      25,     4,     5,    20,     6,     7,    15,    26,    10,    11,
      12,    13,    18,    29,    29,    30,    30,    16,    23,    28,
      28,    28,    28,    16
};
...
#line 96 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("SE",(yyvsp[-1].no),(yyvsp[0].no));}
...
#line 98 "parser.y" /* yacc.c:1646  */
    { (yyval.no) = novo_no("",(yyvsp[-1].no), novo_no((yyvsp[0].simbolo),NULL,NULL)); }
#line 1300 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 99 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("",(yyvsp[-1].no),(yyvsp[0].no));}
...
#line 105 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("RECEBE",novo_no((yyvsp[-2].simbolo),NULL,NULL),novo_no((yyvsp[0].simbolo),NULL,NULL));}
...
#line 109 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("",(yyvsp[-1].no),NULL);}
#line 1330 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 112 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("VERDADEIRO",NULL,NULL); }
#line 1336 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 113 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("FALSO",NULL,NULL); }
#line 1342 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 114 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("MAIOR",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1348 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 115 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("MENOR",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1354 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 116 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("MAIOR_IGUAL",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1360 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 117 "parser.y" /* yacc.c:1646  */
    {(yyval.no) = novo_no("MENOR_IGUAL",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1366 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 121 "parser.y" /* yacc.c:1646  */
    { (yyval.no) = novo_no("MAIS",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1372 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 122 "parser.y" /* yacc.c:1646  */
    { (yyval.no) = novo_no("MENOS",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1378 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 126 "parser.y" /* yacc.c:1646  */
    { (yyval.no) = novo_no("VEZES",(yyvsp[-2].no),(yyvsp[0].no)); }
#line 1384 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 127 "parser.y" /* yacc.c:1646  */
    { (yyval.no) = novo_no("DIVIDIDO",(yyvsp[-2].no),(yyvsp[0].no)); }
...
#line 130 "parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.no) = novo_no(str,NULL,NULL);
    }
